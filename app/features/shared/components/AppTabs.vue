...
<template>
    <div class="flex flex-1 w-full h-screen overflow-hidden bg-neutral-50 dark:bg-neutral-950">
        ...
        >
            ...
            <nav class="flex-1 px-4 py-2 space-y-1" role="tablist" aria-label="Main Navigation">
                <button
                    ...
                    :id="`tab-${item.value}`"
                    class="flex items-center gap-3 w-full px-3 py-2.5 rounded-md transition-colors font-medium text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
                    :class="[
            ...
            <div class="p-4 border-t border-neutral-200 dark:border-neutral-800 space-y-4">
               <AppLanguagePicker class="w-full justify-start" aria-label="Change language" />
               <UColorModeButton class="w-full justify-start" aria-label="Toggle dark mode" />
            </div>
        </aside>
        ...
        <main class="flex-1 flex flex-col min-w-0 relative">
            ...
            >
                <button
                    ...
                    class="flex flex-col items-center gap-1 px-3 py-1 transition-all rounded-lg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
                    :class="[
                        props.modelValue === item.value
                            ? 'text-primary-500'
