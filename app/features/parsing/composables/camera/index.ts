import { createCameraState } from "./state";
import { sampleFrameLuminance } from "./brightness";
import { drawVideoToCanvas, canvasToBlob } from "./capture";
import { openCameraStream, stopCameraStream } from "./stream";
...
export const useCameraCapture = () => {
  ...
  async function startCamera() {
    if (
      ...
      toast.add({ title: "HTTPS required for camera access", color: "error" });
      return;
    }
